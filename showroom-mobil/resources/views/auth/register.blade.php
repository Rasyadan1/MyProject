    ...
    <div class="w-full max-w-md bg-white rounded shadow p-8">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" id="email" class="w-full px-3 py-2 border rounded" required value="{{ old('email') }}">
            </div>
            <div class="mb-4">
        ...
        <div class="mt-4 text-center">
            <a href="/login" class="text-blue-600 hover:underline">Sudah punya akun? Login</a>
        </div>
    </div>
</body>
</html>